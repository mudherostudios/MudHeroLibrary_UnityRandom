...
namespace URandom
{
	public static class RandomDisk
	{
		...
		public static Vector2 Circle( ref NPack.MersenneTwister _rand, MudHeroRandom.Normalization n, float t )
		{
			float r;
			switch (n) {
		...
		public static Vector2 Disk( ref NPack.MersenneTwister _rand, MudHeroRandom.Normalization n, float temp )
		{
			double t, theta;
